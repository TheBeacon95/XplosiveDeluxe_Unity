...
public class StateBlockTile : EnvironmentTileAbs, BlockStateIfc {
    ...
    public override bool IsWalkable(bool isGhost) {
        switch (m_type) {
            case StateBlockType.OnBlock:
                return m_levelManager.BlockState.IsOn;
            case StateBlockType.OffBlock:
                return m_levelManager.BlockState.IsOff;
    ...
    private void UpdateSprite() {
        sprite = m_levelManager.BlockState.IsOn ? m_onSprite : m_offSprite;
    }
